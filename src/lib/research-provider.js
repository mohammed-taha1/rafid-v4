...
function createResearchProvider() {
  ...
  return {
    ...
    async analyze({ chunks, outputLanguage }) {
      const request = requestFor("score", { chunks, output_language: outputLanguage });
      try {
...
module.exports={ProviderError,createGroqAdapter,createGroqResearchProvider:createResearchProvider,modelOutputSchema,normalizeModelAnalysis,safeMessage,safeProviderCode};
