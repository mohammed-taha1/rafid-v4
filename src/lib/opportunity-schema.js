...
const requirement = object({
  ...
  // يُترك كنص حر أثناء التوليد لأن بعض النماذج قد تنشئ تسمية
  // وصفية غير مطابقة حرفيًا للـ enum. يطبّعها الخادم بعد الاستلام
  // إلى واحدة من فئات رافد المعتمدة قبل الحفظ والعرض.
  category: string,
  title: string,
  description: string,
