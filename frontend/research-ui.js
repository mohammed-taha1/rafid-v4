    ...
    main.innerHTML = `${header('<nav aria-label="روابط رافد"><a href="#services">الخدمات</a><a href="#institution">للمؤسسات</a><a href="#how">كيف يعمل؟</a><a href="#learn">مركز التعلم</a><a href="#about">عن رافد</a><a href="#contact">تواصل معنا</a></nav>')}
      ...
      <section id="services" class="service-console" aria-labelledby="servicesTitle">
        ...
        <div class="service-grid">
          <button id="startGeneral" class="service-card is-primary" type="button"><span class="service-card-top"><span class="service-number">01</span><span class="service-status">لدي بحث فقط</span></span><strong>قيّم جاهزية البحث</strong><small>اختر هذا المسار إذا لم تحدد فرصة تمويل بعد. ستحصل على تقييم عام للفجوات وخطة التحسين.</small><i>تحليل بحث واحد دون فرصة <b aria-hidden="true">←</b></i></button>
          <button id="startMatch" class="service-card" type="button"><span class="service-card-top"><span class="service-number">02</span><span class="service-status">لدي بحث وفرصة</span></span><strong>طابق البحث مع فرصة محددة</strong><small>اختر هذا المسار إذا لديك شروط فرصة بعينها. سنفحص الأهلية والأدلة والملاءمة لهذه الفرصة فقط.</small><i>مطابقة بحث + فرصة <b aria-hidden="true">←</b></i></button>
          <button id="startDiscovery" class="service-card" type="button"><span class="service-card-top"><span class="service-number">03</span><span class="service-status">لدي بحث وأبحث عن فرصة</span></span><strong>اكتشف الفرص المناسبة</strong><small>رتّب مسارات التمويل الأقرب لبحثك، وافهم سبب الترشيح وما يحتاج تحققًا.</small><i>حلّل البحث واقترح الفرص <b aria-hidden="true">←</b></i></button>
          <button id="startPortfolio" class="service-card" type="button"><span class="service-card-top"><span class="service-number">04</span><span class="service-status">لدي فرصة وعدة مشاريع</span></span><strong>رتّب محفظة المشاريع</strong><small>قارن من مشروعين إلى خمسة بالأهلية أولًا ثم الجاهزية والأدلة.</small><i>قارن المشاريع مؤسسيًا <b aria-hidden="true">←</b></i></button>
        </div>
      </section>
